...
\item 
\mbox{\hyperlink{structDense__layer}{Dense\+\_\+layer}} $\ast$ \mbox{\hyperlink{NN__layers_8c_a80a33d520a9591339962cc53f35870fa}{dense\+\_\+init}} (unsigned int num\+\_\+neurons, unsigned int num\+\_\+inputs, char activation\mbox{[}$\,$\mbox{]})
\item 
int \mbox{\hyperlink{NN__layers_8c_aa8baa0f75d579f6f4196b46e4ba315a9}{dense\+\_\+set\+\_\+rand}} (\mbox{\hyperlink{structDense__layer}{Dense\+\_\+layer}} $\ast$dense\+\_\+layer)
\item 
int \mbox{\hyperlink{NN__layers_8c_abeccd1b1d72eaf2d37c2367838c83e90}{dense\+\_\+forward}} (\mbox{\hyperlink{structDense__layer}{Dense\+\_\+layer}} $\ast$dense\+\_\+layer, \mbox{\hyperlink{structtensor__2d}{tensor\+\_\+2d}} $\ast$mat\+\_\+in, \mbox{\hyperlink{structtensor__2d}{tensor\+\_\+2d}} $\ast$mat\+\_\+out)
\end{DoxyCompactItemize}


\doxysubsection{Function Documentation}
\mbox{\Hypertarget{NN__layers_8c_abeccd1b1d72eaf2d37c2367838c83e90}\label{NN__layers_8c_abeccd1b1d72eaf2d37c2367838c83e90}} 
...
\DoxyCodeLine{00070 }
\DoxyCodeLine{00071     return\_code = \mbox{\hyperlink{tensor__2d_8c_a574ba2646f2cf52aec9655161f3d9607}{mat\_mul}}(mat\_in, dense\_layer-\/>\mbox{\hyperlink{structDense__layer_ae7f1c485520fb725f0549420905c8240}{weights}}, dense\_layer-\/>\mbox{\hyperlink{structDense__layer_a7443971fc4303ae79f5e8134fe2283d7}{Y}}); }
\DoxyCodeLine{00072     \textcolor{keywordflow}{if} (return\_code!=0)\{}
\DoxyCodeLine{00073         \textcolor{keywordflow}{return} 3;}
\DoxyCodeLine{00074     \}}
\DoxyCodeLine{00075     return\_code = \mbox{\hyperlink{tensor__2d_8c_a9ae20928f936d462d68cf5b1596283e2}{mat\_add}}(dense\_layer-\/>\mbox{\hyperlink{structDense__layer_a7443971fc4303ae79f5e8134fe2283d7}{Y}}, dense\_layer-\/>\mbox{\hyperlink{structDense__layer_a31225d6adccfa475c2c9614789aaaea9}{bias}}, dense\_layer-\/>\mbox{\hyperlink{structDense__layer_a7443971fc4303ae79f5e8134fe2283d7}{Y}});}
\DoxyCodeLine{00076     \textcolor{keywordflow}{if} (return\_code!=0)\{}
\DoxyCodeLine{00077         \textcolor{keywordflow}{return} 3;}
\DoxyCodeLine{00078     \}}
\DoxyCodeLine{00079     return\_code = dense\_layer-\/>\mbox{\hyperlink{structDense__layer_a40d2787799fb771ef9b2192fa0de4678}{activation\_ptr}}(dense\_layer-\/>\mbox{\hyperlink{structDense__layer_a7443971fc4303ae79f5e8134fe2283d7}{Y}}, dense\_layer-\/>\mbox{\hyperlink{structDense__layer_ae1520651f0835910fe8ce3a05b16cdfd}{Z}});}
\DoxyCodeLine{00080     \textcolor{keywordflow}{if} (return\_code!=0)\{}
\DoxyCodeLine{00081         \textcolor{keywordflow}{return} 3;}
\DoxyCodeLine{00082     \}}
\DoxyCodeLine{00083 }
\DoxyCodeLine{00084     \mbox{\hyperlink{tensor__2d_8c_ab29c9ef88f94cc1ec4d680df1937cd07}{mat\_copy}}(dense\_layer-\/>\mbox{\hyperlink{structDense__layer_ae1520651f0835910fe8ce3a05b16cdfd}{Z}}, mat\_out);}
\DoxyCodeLine{00085     \textcolor{keywordflow}{return} 0;}
\DoxyCodeLine{00086 \}}

\end{DoxyCode}
\mbox{\Hypertarget{NN__layers_8c_a80a33d520a9591339962cc53f35870fa}\label{NN__layers_8c_a80a33d520a9591339962cc53f35870fa}} 
\index{NN\_layers.c@{NN\_layers.c}!dense\_init@{dense\_init}}
\index{dense\_init@{dense\_init}!NN\_layers.c@{NN\_layers.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{NN__layers_8c_aa8baa0f75d579f6f4196b46e4ba315a9}\label{NN__layers_8c_aa8baa0f75d579f6f4196b46e4ba315a9}} 
...
\DoxyCodeLine{00058     \}}
\DoxyCodeLine{00059     \mbox{\hyperlink{tensor__2d_8c_a1baab197f83282e2cefec25af573e4af}{mat\_rand}}(dense\_layer-\/>\mbox{\hyperlink{structDense__layer_ae7f1c485520fb725f0549420905c8240}{weights}}, 0.1); }
\DoxyCodeLine{00060     \mbox{\hyperlink{tensor__2d_8c_ae908690f3acf39314e6bf3f944f5ca98}{mat\_zeros}}(dense\_layer-\/>\mbox{\hyperlink{structDense__layer_a31225d6adccfa475c2c9614789aaaea9}{bias}}); }
\DoxyCodeLine{00061 }
