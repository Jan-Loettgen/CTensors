...
This file contains the declaration of functions and structs of various neural network layer types.  
...
\begin{DoxyCompactList}\small\item\em \texorpdfstring{$<$}{<} this library is necessary as it provides the backend matrix functionality required for a neural network. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{structDense__layer}{Dense\+\_\+layer}} $\ast$ \mbox{\hyperlink{NN__layers_8h_ad57cc00b888a6e34dd7cda77f0859c47}{dense\+\_\+make}} (unsigned int num\+\_\+neurons, unsigned int num\+\_\+inputs, char activation\mbox{[}$\,$\mbox{]})
...
int \mbox{\hyperlink{NN__layers_8h_a29b58829b8032d6455095a97ee40e160}{dense\+\_\+free}} (\mbox{\hyperlink{structDense__layer}{Dense\+\_\+layer}} $\ast$$\ast$dense\+\_\+layer)
...
int \mbox{\hyperlink{NN__layers_8h_a02ed8661062be087e1407077387478c2}{dense\+\_\+set\+\_\+rand}} (double low, double high, \mbox{\hyperlink{structDense__layer}{Dense\+\_\+layer}} $\ast$dense\+\_\+layer)
...
int \mbox{\hyperlink{NN__layers_8h_a1c0547d8e31b12285bfcee00339e96c4}{dense\+\_\+forward}} (\mbox{\hyperlink{structDense__layer}{Dense\+\_\+layer}} $\ast$dense\+\_\+layer, \mbox{\hyperlink{structtensor__2d}{tensor\+\_\+2d}} $\ast$mat\+\_\+in, \mbox{\hyperlink{structtensor__2d}{tensor\+\_\+2d}} $\ast$mat\+\_\+out, bool training)
...
Definition in file \mbox{\hyperlink{NN__layers_8h_source}{NN\+\_\+layers.\+h}}.
...
\mbox{\Hypertarget{NN__layers_8h_a1c0547d8e31b12285bfcee00339e96c4}\label{NN__layers_8h_a1c0547d8e31b12285bfcee00339e96c4}} 
...
\DoxyCodeLine{00085                                                                                                  \{}
\DoxyCodeLine{00086 }
\DoxyCodeLine{00087     \textcolor{keywordflow}{if} (\mbox{\hyperlink{NN__layers_8c_a29b58829b8032d6455095a97ee40e160}{dense\_free}} == NULL || mat\_in == NULL || mat\_out == NULL)\{}
...
\end{DoxyCode}
\mbox{\Hypertarget{NN__layers_8h_a29b58829b8032d6455095a97ee40e160}\label{NN__layers_8h_a29b58829b8032d6455095a97ee40e160}} 
\index{NN\_layers.h@{NN\_layers.h}!dense\_free@{dense\_free}}
\index{dense\_free@{dense\_free}!NN\_layers.h@{NN\_layers.h}}
...
\end{DoxyCode}
\mbox{\Hypertarget{NN__layers_8h_ad57cc00b888a6e34dd7cda77f0859c47}\label{NN__layers_8h_ad57cc00b888a6e34dd7cda77f0859c47}} 
\index{NN\_layers.h@{NN\_layers.h}!dense\_make@{dense\_make}}
\index{dense\_make@{dense\_make}!NN\_layers.h@{NN\_layers.h}}
...
\end{DoxyCode}
\mbox{\Hypertarget{NN__layers_8h_a02ed8661062be087e1407077387478c2}\label{NN__layers_8h_a02ed8661062be087e1407077387478c2}} 
